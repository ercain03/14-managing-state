...
// fills the filter templates from the DB, discarding duplicates. Fired by articleView.index
  ...
  // COMMENTs: What does this method do?  What is it's execution path?
// handle filters grabs the selection from the filter box, uses the selection
// in the URL (line47) to return matching articles
//triggered in route.js, fires either '/'(home), loadByAuthor and/or loadByCategory
  ...
  // COMMENTs: What does this method do?  What is it's execution path?
// this show the #articles and hides the other 'pages', appends articles to #article section
  articleView.index = function(articles) {
    $('#articles').show().siblings().hide();
// remove any existing article in #articles
    $('#articles article').remove();
//appends each article to #articles, using render to fire handlebars templates
    ...
    // COMMENTs: What does this method do?  What is it's execution path?
//  handleFilters takes the selction form the filters, uses the ctx object to pass that
// data through the callback chain to make SQL queries to return matching articles and append to DOM
